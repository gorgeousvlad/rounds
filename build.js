...
// var $ = require("jquery");
var Round = __webpack_require__(1);

const MAX = 20;
const COLORS = [{ "color": "blue", "indent": 0 }, { "color": "green", "indent": 25 }, { "color": "red", "indent": 35 }, { "color": "purple", "indent": 45 }];
	...
	requestAnimationFrame(function frame() {
		...
		rounds.forEach(round => {
			if (round.data("direction") === undefined) {
				if (Math.round(Math.random()) > 0) round.data("direction", 1);else round.data("direction", -1);
			}
